...
let favoritePizzas: string [] = ["pepperoni","chicken ","chili,BBQ"];

console.log("print a sentence for each pizza");
...
console.log("\n These are some of my favorite pizza, and I really like pizza ")
